    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
               appId: "836542427178862",
               appSecret: "d48b393c60ec33cb1f790cfb28551c1f");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "213822927774-fsv0jlru48j9it8b4p6ddrbt324en2jg.apps.googleusercontent.com",
                ClientSecret = "fYhG8X1T9InvoBtlkQ2NGB_H"
            });
        }
    }
}